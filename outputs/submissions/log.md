...
| 3 | 2026-04-02 | 0.7677 | TBD | LogReg (C=1, balanced, liblinear) | Word TF-IDF (5000) + Char TF-IDF (3000) + keywords + numeric (text_len, word_count, mention_count, hashtag_count) | Advanced features — char n-grams + mention/hashtag counts. Best CV F1 so far (+0.020 vs baseline) |
