...
| 5 | 2026-04-13 | 0.7865 | TBD | LogReg (C=1, balanced, liblinear) | Concat: TF-IDF (8226) + DistilBERT embeddings (768) + keyword + numeric = 9220 features | Phase 4 — BERT embeddings. BERT alone 0.7862, concat 0.7865. CV +0.019 vs TF-IDF |
