...
| 5 | 2026-04-13 | 0.7865 | 0.80907 | LogReg (C=1, balanced, liblinear) | Concat: TF-IDF (8226) + DistilBERT embeddings (768) + keyword + numeric = 9220 features | Phase 4 — BERT embeddings. New best LB (+0.005 vs #3). BERT and TF-IDF complementary |
