...
from src.features import KeywordEncoder, NumericFeatures, TextTfidfTransformer, build_feature_matrix
...
def test_build_feature_matrix():
    ...
    x_train, x_test, tfidf, kw, num = build_feature_matrix(train, test, max_features=100)
